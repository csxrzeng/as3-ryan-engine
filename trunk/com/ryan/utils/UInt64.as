...
package com.ryan.utils
{
	...
	public final class UInt64 extends Binary64
	{
		 ...
		 * @return
		 */
		public function divide(value:UInt64):Number
		{
			return (internalHigh + low / (uint.MAX_VALUE + 1)) / (value.internalHigh + value.low / (uint.MAX_VALUE + 1));
		}
		 ...
		 * @return
		 */
		public function substract(value:UInt64):Int64
		{
			if (value.low > low)
			{
				return new Int64(low - value.low, internalHigh - value.internalHigh - 1);
			}
			return new Int64(low - value.low, internalHigh - value.internalHigh);
		}
	}
}
